...
export type Body_saves_inspect_save = {
    file: (Blob | File);
};
...
export type InspectResponse = {
    platform: string;
    slots: Array<InspectSlot>;
};

/**
 * One character slot's relic contents, content-triples only.
 */
export type InspectSlot = {
    slot_index: number;
    name: string;
    relics: Array<AddRelicSpec>;
};
...
export type SavesInspectSaveData = {
    formData: Body_saves_inspect_save;
};

export type SavesInspectSaveResponse = (InspectResponse);
