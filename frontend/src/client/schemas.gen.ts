...
export const AddRelicSpecSchema = {
    properties: {
        real_id: {
            type: 'integer',
            title: 'Real Id'
    ...
    type: 'object',
    required: ['real_id', 'effects', 'curses'],
    title: 'AddRelicSpec',
    description: 'A concrete relic to mint into a save (from a prior roll).'
} as const;
...
export const Body_saves_inspect_saveSchema = {
    properties: {
        file: {
            type: 'string',
            format: 'binary',
...
export const InspectResponseSchema = {
    properties: {
        platform: {
            type: 'string',
            title: 'Platform'
        ...
        slots: {
            items: {
                '$ref': '#/components/schemas/InspectSlot'
            },
            type: 'array',
            title: 'Slots'
        }
    ...
    description: `Parse-only view of a save file (POST /saves/inspect persists NOTHING).
...
export const InspectSlotSchema = {
    properties: {
        slot_index: {
            type: 'integer',
            title: 'Slot Index'
        ...
        relics: {
            items: {
                '$ref': '#/components/schemas/AddRelicSpec'
            },
            type: 'array',
            title: 'Relics'
        }
    ...
    type: 'object',
    required: ['slot_index', 'name', 'relics'],
    title: 'InspectSlot',
    description: "One character slot's relic contents, content-triples only."
} as const;
